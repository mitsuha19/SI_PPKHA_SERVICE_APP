                    ...
                    <div class="card-information d-flex align-items-center px-3">
                        @if ($l->perusahaan && $l->perusahaan->logo)
                            <img style="width: 100px"
                                src="{{ config('services.main_api.url') }}/storage/{{ $l->perusahaan->logo }}"
                                alt="Logo Perusahaan">
                        @else
                            <img style="width: 100px" src="{{ asset('assets/images/default-logo.png') }}"
                                alt="Default Logo">
                        @endif
                        ...
                        <div class="ps-3 w-100">
                            ...
                            <p class="mb-0 montserrat-light">
                                {{ $l->perusahaan->namaPerusahaan ?? 'Perusahaan tidak tersedia' }}</p>
