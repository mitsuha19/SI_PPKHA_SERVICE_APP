                ...
                <div class="background-card">
                    <div class="card-information d-flex align-items-center px-3">
                        @php
                            ...
                            $logoUrl = $p->logo ? $backendUrl . '/storage/' . $p->logo : null;
                            \Log::info('Logo URL for perusahaan ' . $p->id . ': ' . ($logoUrl ?? 'No logo'));
                        @endphp

                        <img src="{{ $logoUrl ?? asset('assets/images/default-logo.png') }}" alt="Logo Perusahaan"
